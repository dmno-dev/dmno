...
Basically, you need to follow these rules: 

- if you want to use config in the browser (i.e. a Client Component), you should access it using `DMNO_PUBLIC_CONFIG`
- if you want to use config on the server (i.e. a React Server Component or an API Route), you should access it via `process.dmnoEnv`
