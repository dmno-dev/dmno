...
For an exhaustive list of all the options available for each schema item, check out the [defineDmnoService](/reference/config-engine/helper-methods/#definedmnoservice) reference docs.
