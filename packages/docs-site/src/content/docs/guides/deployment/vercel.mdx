...
We're assuming you're already familiar with both DMNO and Vercel. If you're not, you can learn more about DMNO [here](/get-started/quickstart) and Vercel [here](https://vercel.com/docs). 

## Prerequisites

Before you start, you'll need to have the following:

- A set of [DMNO Schema](/guides/schema) definitions
...
:::tip
For an in-depth look at DMNO Secrets, check out the [secrets guide](/guides/plugins/overview).
:::
...
:::tip
For an in-depth look at DMNO 1Password Sync, check out the [1Password Sync guide](/reference/plugins/1pass).
:::
