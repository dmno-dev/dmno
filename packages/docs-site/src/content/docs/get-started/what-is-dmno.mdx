...
DMNO is not enterprise configuration and secrets management. It certainly provides you with the tools to integrate with the enterprise tool of your choice but we're not trying to compete with mega-expensive all-encompassing products. Will we eventually grow into that world? Maybe, but it's not our focus today. 
