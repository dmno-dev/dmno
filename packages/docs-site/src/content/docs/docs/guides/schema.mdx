...
For an exhaustive list of all the options available for each schema item, check out the [config item](/docs/reference/helper-methods/#configitemdefinition) reference docs.
