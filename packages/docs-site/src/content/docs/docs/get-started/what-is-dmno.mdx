...
The core of DMNO is **DMNO Config**, our configuration system. It allows you create a type-safe schema of environment variables, giving you a fully-integrated developer experience via typescript Intellisense and contextual documentation. 
