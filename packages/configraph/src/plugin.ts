...
// export abstract class ConfigraphPluginOld<
//   ChildPlugin extends ConfigraphPluginOld = NoopPlugin,
// > {
...
//     const PluginClass = this.constructor as typeof ConfigraphPluginOld;
...
// class NoopPlugin extends ConfigraphPluginOld {}



export abstract class ConfigraphPlugin<NodeMetadata = unknown> {
  /** name of the plugin itself - which is the name of the class */
  pluginType = this.constructor.name;
  /** iconify icon name */
  icon?: string;
